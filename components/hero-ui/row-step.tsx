              ...
              >
                ...
                >
                  ...
                  <div className="max-w-full flex-1 text-start">
                    <div
                      className={cn(
                        "font-medium text-default-foreground transition-[color,opacity] duration-300 text-small group-active:opacity-80 lg:text-medium",
                        {
                  ...
                  {stepIdx < steps.length - 1 && !hideProgressBars && (
                    ...
                    >
                      <div
                        className={cn(
                          "bg-(--inactive-bar-color) relative h-0.5 w-full transition-colors duration-300",
                          "after:bg-(--active-border-color) after:absolute after:block after:h-full after:w-0 after:transition-[width] after:duration-300 after:content-['']",
                          {
